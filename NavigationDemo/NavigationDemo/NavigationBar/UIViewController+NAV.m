...
- (void)fd_setNeedsStatusBarAppearanceUpdate {
...
- (void)fd_viewWillAppear:(BOOL)animated {
    ...
    [self fd_setNeedsStatusBarAppearanceUpdate];
}

- (void)fd_traitCollectionDidChange:(nullable UITraitCollection *)previousTraitCollection {
    [self fd_traitCollectionDidChange:previousTraitCollection];
